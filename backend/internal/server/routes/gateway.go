...
func RegisterGatewayRoutes(
	...
	r.POST("/responses/*subpath", bodyLimit, clientRequestID, opsErrorLogger, endpointNorm, gin.HandlerFunc(apiKeyAuth), auditCapture, compositeTarget, requireGroupAnthropic, responsesHandler)
