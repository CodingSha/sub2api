...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	coordinator := securityaudit.NewCoordinatorWithWhitelist(legacyEngine, promptService, auditService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, optionalJWTAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, auditService, settingService, compositeRouteResolver, redisClient)
