export default {
  ...
  admin: {
    ...
    audit: {
      title: 'Content Audit',
      description: 'Review all LLM request and response content with filters for model, platform, and risk level',
      reset: 'Reset Filters',
      export: 'Export',
      refresh: 'Refresh',
      ...
      failed: 'Failed',
      search: 'Search',
      searchPlaceholder: 'User, key, account, request ID',
      platform: 'Platform',
      model: 'Model',
      ...
      retentionBadge: 'Capturing gateway traffic',
      time: 'Time',
      user: 'User',
      risk: 'Risk',
      statusCode: 'Status',
      ...
      turnPageSummary: 'Showing turns {start}-{end} of {total}',
      ...
      toolStatus: 'Status',
      toolError: 'Failed',
      inferredToolCall: 'A tool call was detected, but the original audit record did not retain the tool name or arguments.',
      loadEarlierTurns: 'Load 10 earlier turns',
      loadingEarlierTurns: 'Loading...',
      noMoreTurns: 'No more conversation',
      emptyConversation: 'No replayable conversation content',
      previousPage: 'Previous page',
      nextPage: 'Next page',
      emptyTitle: 'No audit records yet',
      emptyDescription: 'Send a model request through the gateway, then refresh this page to review the captured request and response.',
      noSelectionTitle: 'Select a record to view details',
      noSelectionDescription: 'Details show the captured request body, response body, status, and trace information.',
      allPlatforms: 'All Platforms',
      allStatuses: 'All Levels',
      allDirections: 'Requests and Responses',
      request: 'Request',
      response: 'Response',
      riskLow: 'Low',
      riskMedium: 'Medium',
