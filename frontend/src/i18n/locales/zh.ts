export default {
  ...
  admin: {
    ...
    audit: {
      title: '内容审计',
      description: '集中审阅所有大模型请求和回复内容，支持按模型、平台、风险等级筛选',
      reset: '重置筛选',
      export: '导出',
      refresh: '刷新',
      totalRecords: '审计记录',
      ...
      failed: '失败请求',
      search: '搜索',
      searchPlaceholder: '用户、Key、账号、请求 ID',
      platform: '平台',
      model: '模型',
      ...
      turnPageSummary: '显示第 {start}-{end} 轮，共 {total} 轮',
      userMessage: '用户输入',
      ...
      toolStatus: '状态',
      toolError: '执行失败',
      inferredToolCall: '检测到一次工具调用，原始审计记录未保留工具名和参数。',
      loadEarlierTurns: '加载更早的 10 轮',
      loadingEarlierTurns: '正在加载...',
      noMoreTurns: '没有更多对话',
      emptyConversation: '暂无可回放的对话内容',
      previousPage: '上一页',
      nextPage: '下一页',
      emptyTitle: '暂无审计记录',
      emptyDescription: '通过网关发送一次模型请求后，刷新这里即可查看采集到的请求和回复。',
      noSelectionTitle: '选择一条记录查看详情',
      noSelectionDescription: '详情区会展示请求体、回复体、状态和追踪信息。',
      allPlatforms: '全部平台',
      allStatuses: '全部等级',
      allDirections: '请求和回复',
      request: '请求',
